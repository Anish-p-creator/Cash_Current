// Renders the Personal Finance Dashboard (converted from front2.html)
// Usage: include this file and call renderFinanceDashboard();

export function renderFinanceDashboard(target = document.body) {
  const style = document.createElement('style');
  style.textContent = `
    :root { --bg:#f7f7fb; --card:#ffffff; --text:#0f172a; --muted:#6b7280; --border:#e5e7eb; --chip:#eef2f7; --green:#16a34a; --red:#dc2626; }
...
// Auto-mount if loaded directly in a browser without modules
if (typeof window !== 'undefined' && !window.__FIN_DASH_MOUNTED__) {
  window.__FIN_DASH_MOUNTED__ = true;
