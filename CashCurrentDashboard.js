...
const CashCurrentDashboard = () => {
  ...
  const smartInsights = [
    { type: 'warning', title: "You've spent 25% more on dining out this week compared to your average.", category: 'Dining', trend: 'Up', percentage: '+25.3%' },
    ...
    { type: 'warning', title: "Shopping expenses have increased by 30% this week. Most purchases were at Target and Amazon.", category: 'Shopping', trend: 'Up', percentage: '+38.7%' },
  ...
  // New mock data for Financial Heartbeat Chart
  const financialHeartbeatData = {
    ...
    datasets: [
      ...
      },
      {
        ...
        data: [250, 280, 220, 310, 240, 290, 275],
  ...
  // New mock data for 30-Day Balance Projection Chart
    ...
    datasets: [
      {
        ...
        data: [
          12656, 12500, 12300, 12000, 11800, 11500, 11200, 11000, 10800, 10500,
          10200, 9900, 9600, 9300, 9000, 8700, 8500, 8300, 8100, 7900, 7700,
          7500, 7300, 7100, 6900, 6700, 6500, 6300, 6100, 5900,
        ],
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <main className="ml-64 flex-1 bg-gray-50 min-h-screen">
        ...
        <div className="p-8">
          {/* Account Cards and Financial Heartbeat */}
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
            ...
            {/* Spending and Transactions on the right */}
          ...
          {/* Smart Insights (now at the bottom) */}
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="mb-6">
              <h3 className="text-lg font-semibold flex items-center">
